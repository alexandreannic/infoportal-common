...
export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
  ...
  phone: number | undefined,
	  // module_eligibility_screening/inclusion_exclusion_group/ingo [select_one] Are you registered to receive cash from an NGO?
  ...
  The_average_income_o_per_month_per_person: string,
	  // module_eligibility_screening/inclusion_exclusion_group/exclusion_1 [select_one] This household is not eligible for cash assistance because they are receiving or due to receive cash from an NGO.
  ...
  child_hhh: string,
	  // mpca_targeting_criteria/h/h_note [note] **Age/Sex**
  h_note: string,
	  // mpca_targeting_criteria/h/h_c1 [note] **No of Males**
  h_c1: string,
	  // mpca_targeting_criteria/h/h_c2 [note] **No of Females**
  h_c2: string,
	  // mpca_targeting_criteria/h/h_c3 [note] **Total (Row)**
  h_c3: string,
	  // mpca_targeting_criteria/r1/r1_note [note] ##### 0-4 Years
  r1_note: string,
	  // mpca_targeting_criteria/r1/r1_c1 [integer] <span style="display:none">r1-No of Males</span>
  r1_c1: number | undefined,
	  // mpca_targeting_criteria/r1/r1_c2 [integer] <span style="display:none">r1-No of Females</span>
  r1_c2: number | undefined,
	  // mpca_targeting_criteria/r1/r1_c3 [integer] <span style="display:none">r1-Total (Row)</span>
  r1_c3: number | undefined,
	  // mpca_targeting_criteria/r2/r2_note [note] ##### 5-17 Years
  r2_note: string,
	  // mpca_targeting_criteria/r2/r2_c1 [integer] <span style="display:none">r2-No of Males</span>
  r2_c1: number | undefined,
	  // mpca_targeting_criteria/r2/r2_c2 [integer] <span style="display:none">r2-No of Females</span>
  r2_c2: number | undefined,
	  // mpca_targeting_criteria/r2/r2_c3 [integer] <span style="display:none">r2-Total (Row)</span>
  r2_c3: number | undefined,
	  // mpca_targeting_criteria/r3/r3_note [note] ##### 18 - 59 Years
  r3_note: string,
	  // mpca_targeting_criteria/r3/r3_c1 [integer] <span style="display:none">r3-No of Males</span>
  r3_c1: number | undefined,
	  // mpca_targeting_criteria/r3/r3_c2 [integer] <span style="display:none">r3-No of Females</span>
  r3_c2: number | undefined,
	  // mpca_targeting_criteria/r3/r3_c3 [integer] <span style="display:none">r3-Total (Row)</span>
  r3_c3: number | undefined,
	  // mpca_targeting_criteria/r4/r4_note [note] ##### 60+ Years
  r4_note: string,
	  // mpca_targeting_criteria/r4/r4_c1 [integer] <span style="display:none">r4-No of Males</span>
  r4_c1: number | undefined,
	  // mpca_targeting_criteria/r4/r4_c2 [integer] <span style="display:none">r4-No of Females</span>
  r4_c2: number | undefined,
	  // mpca_targeting_criteria/r4/r4_c3 [integer] <span style="display:none">r4-Total (Row)</span>
  r4_c3: number | undefined,
	  // mpca_targeting_criteria/r5/r5_note [note] ##### Total (Column)
  r5_note: string,
	  // mpca_targeting_criteria/r5/r5_c1 [integer] <span style="display:none">r5-No of Males</span>
  r5_c1: number | undefined,
	  // mpca_targeting_criteria/r5/r5_c2 [integer] <span style="display:none">r5-No of Females</span>
  r5_c2: number | undefined,
	  // mpca_targeting_criteria/r5/r5_c3 [integer] <span style="display:none">r5-Total (Row)</span>
  ...
  child_custody: undefined | Option<'child_custody'>,
	  // mpca_targeting_criteria/damaged_inclusion_criteria [select_one] Is this household affected by sudden shelling including those where people have lost family member, houses, livelihoods (damaged shop/lost, farm, livestock)?
  ...
  mpca_eligible_vul: undefined | Option<'mpca_eligible_vul'>,
	  // cash_yes/mpca_tot_transfer_value [calculate] undefined
  mpca_tot_transfer_value: string,
	  // cash_yes/eligible_mpca_tv [note] You are eligible for cash assistance and according to the information provided, your household will receive a total transfer of ${mpca_tot_transfer_value} UAH (total number of people in HH * 2220 UAH * 3 months). We will now ask you some detailed questions about yourself.
  eligible_mpca_tv: string,
	  // cash_yes/Should_this_household_be_consi [select_one] Should this household be considered for cash for rent?
  Should_this_household_be_consi: undefined | Option<'Should_this_household_be_consi'>,
	  // cash_yes/Is_this_household_currently_re [select_one] Is this household currently renting or planning to rent an apartment/home?
  Is_this_household_currently_re: undefined | Option<'Is_this_household_currently_re'>,
	  // cash_yes/The_household_is_to_t_NO_start_up_grant [note] The household is to be considered to receive cash-for-rent (NO start-up grant).
  The_household_is_to_t_NO_start_up_grant: string,
	  // cash_yes/The_household_is_to_WITH_start_up_grant [note] The household is to be considered to receive cash-for-rent (WITH start-up grant).
  ...
  no_resident_permit: string | undefined,
	  // cash_yes/passport_serial [text] Enter passport series
  passport_serial: string | undefined,
	  // cash_yes/passport_number [text] Enter passport number
  passport_number: string | undefined,
	  // cash_yes/your_id [text] What is your Tax ID?
  your_id: string | undefined,
	  // cash_yes/registration_address [text] Enter registration address
  registration_address: string | undefined,
	  // cash_yes/confirm_phone [text] Confirm phone number of person receiving MPCA
  ...
  photo_reg_passport_001: string,
	  // delivery_mechanisms/What_is_your_preferred_payment [select_one] What is your preferred payment method?
  What_is_your_preferred_payment: undefined | Option<'What_is_your_preferred_payment'>,
	  // delivery_mechanisms/reason [select_multiple] If banks are not an option, for what reason?
  reason: undefined | Option<'reason'>[],
	  // delivery_mechanisms/specify [text] If none of the options are available, please specify the reason
  specify: string | undefined,
	  // delivery_mechanisms/Photo_of_IBAN [image] Photo of IBAN
